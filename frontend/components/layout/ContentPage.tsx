...
export default function ContentPage({
  ...
  useEffect(() => {
    // Tenta focar automaticamente no conteúdo central para que o leitor de tela já inicie a leitura correta
  ...
  return (
    <div className="bg-gray-100 min-h-dvh relative z-0">
      <div 
        ref={contentRef}
        tabIndex={-1}
        className="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8 sm:py-10 focus:outline-none"
      >
        ...
        <div className="mb-7 flex flex-col items-center text-center">
          ...
          <div
          role="presentation"
            className={`mb-3.5 h-[3px] w-9 rounded-full bg-[#173572] ${
