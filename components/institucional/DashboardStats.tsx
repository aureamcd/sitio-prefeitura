 ...
 * - Cards de métricas (total, respondidos, etc.)
 * - Gráfico de barras horizontal (CSS puro, sem lib externa)
 * - Exportação CSV e PDF
 * - Auto-refresh a cada 60 segundos
 * - Loading skeleton enquanto carrega
 *
 * Consome a API /api/esic/stats ou /api/ouvidoria/stats
 *
...
export default function DashboardStats({ apiUrl, title, canal }: DashboardStatsProps) {
  ...
  /* Carrega ao montar + auto-refresh */
  useEffect(() => {
    fetchStats();
  ...
  return (
    <div>
      ...
      {/* Gráfico de barras + perfil + tempo médio */}
