...
export default async function EditarLegislacaoPage(props: { params: Promise<{ id: string }> }) {
  ...
  return <DocumentoForm mode="editar" initialData={data} categoriaInicial="leis-normas" />;
}
