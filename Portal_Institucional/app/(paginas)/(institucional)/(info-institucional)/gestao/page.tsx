                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {secretarias.map(([_, sec], idx) => (
                        ...
                        >
                            ...
                            <span className="text-gray-400 text-[10px] font-bold mt-4 block border-t border-gray-100 pt-3">
                                Informações completas na Estrutura Organizacional
                            </span>
                        </div>
                    ))}
                </div>
            ...
            <section className="mb-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    {orgaos.map(([slug, item], idx) => (
                        <div 
                            key={idx} 
                            className="bg-white border rounded-2xl p-6 shadow-sm border-l-4 border-gray-400"
                        >
                            <h3 className="font-bold text-gray-900">{item.cargo}</h3>
                            <p className="text-sm text-gray-600 mt-1">{item.nome}</p>
                            <span className="text-[10px] text-gray-400 font-bold uppercase mt-3 block">Informações na Estrutura Organizacional</span>
                        </div>
                    ))}
                </div>
            </section>
