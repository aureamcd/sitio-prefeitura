...
export default function ContatosPage() {
    ...
    // Mapeando secretarias do JSON — usando endereço real de cada uma
    const secretarias: Unidade[] = portalData.secretarias.map(s => ({
        nome: s.nome,
        endereco: s.endereco || "Rua Anfrísio Macedo, 150, Centro, Padre Marcos - PI",
        telefone: s.telefone,
        email: s.email,
        horario: s.horario || "Segunda a sexta, das 08h às 12h",
    }));
