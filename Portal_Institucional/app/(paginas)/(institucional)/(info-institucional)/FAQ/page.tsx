...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    resposta: "Os contatos da Prefeitura, incluindo telefone, e-mail e endereço, estão disponíveis na página de 'Contatos e Atendimento'.",
  },
  {
    id: "g3",
    categoria: "Geral",
    pergunta: "Onde consultar leis municipais?",
    resposta: (
      <>
        A legislação municipal está disponível na seção de{" "}
        <Link href="/leis-normas" className="text-blue-600 font-medium hover:underline">
          Leis e Normas
        </Link>{" "}
        do nosso site, permitindo a busca por tipo, ano e número.
      </>
    ),
  },
  ...
  // Transparência e Licitações
  {
    ...
    pergunta: "Como acessar o Portal da Transparência?",
    resposta: "O Portal da Transparência pode ser acessado através do menu principal do site oficial, garantindo o acesso público a todas as informações fiscais, despesas, receitas e contratos do município.",
  },
  {
    id: "t2",
    categoria: "Transparência e Licitações",
    pergunta: "Como acompanhar licitações?",
    resposta: "Todos os processos licitatórios estão publicados no Portal da Transparência, na aba 'Licitações', onde é possível baixar os editais, acompanhar avisos, resultados e visualizar os contratos firmados.",
  },
  ...
  // Ouvidoria
  {
    ...
    resposta: (
      <>
        ...
        , disponível de forma online em nosso site.
      </>
    ),
  },
  {
    ...
    resposta: "Você pode solicitar informações acessando o Sistema Eletrônico do Serviço de Informação ao Cidadão (e-SIC) em nossa plataforma. Basta realizar um breve cadastro, abrir um chamado e acompanhar o prazo de resposta estabelecido em lei.",
  },
  {
    id: "o3",
    categoria: "Ouvidoria",
  ...
  // Tributos
  {
    ...
    resposta: "A emissão da NFS-e é realizada através do Portal do Contribuinte no site da prefeitura, acessando a área de Serviços Digitais e utilizando o seu login e senha fornecidos no momento do credenciamento da sua empresa.",
  },
  ...
  // Infraestrutura
  {
    ...
    resposta: (
      <>
        O cidadão pode solicitar o serviço de troca de lâmpadas ou reparos informando o endereço exato do poste através da{" "}
        <Link href="/ouvidoria" className="text-blue-600 font-medium hover:underline">
          Ouvidoria Municipal
        </Link>{" "}
  ...
  // Assistência Social
  {
    ...
    resposta: "Para ingressar em programas sociais do governo federal, estadual ou municipal, você deve procurar o Centro de Referência de Assistência Social (CRAS) portando seus documentos pessoais e comprovantes de renda para se inscrever ou atualizar o Cadastro Único (CadÚnico).",
  },
];
...
export default function FAQPage() {
  ...
  // Agrupa FAQs filtradas por categoria
      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <section className="text-center space-y-6">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Encontre respostas rápidas para as principais dúvidas sobre os serviços da prefeitura e o acesso à informação pública.
          </p>
        ...
        <section className="space-y-8">
          {Object.keys(groupedFaqs).length === 0 ? (
            <div className="text-center py-16 bg-gray-50 rounded-2xl border border-gray-100">
              <p className="text-gray-500 font-medium text-lg">Nenhuma pergunta encontrada para "{busca}"</p>
              <button 
                onClick={() => setBusca("")}
        ...
        <div className="mt-12 bg-blue-50/50 border border-blue-100 rounded-2xl p-6 text-center space-y-2">
          ...
          <p className="text-sm text-gray-500">
            Acesse nossa <Link href="/ouvidoria" className="text-[#0B3D91] font-bold hover:underline">Ouvidoria</Link> ou entre em contato pelos nossos canais oficiais de atendimento.
          </p>
        </div>
