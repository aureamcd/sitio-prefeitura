...
async function check1711() {
  ...
  console.log("Rows for 1711.00.0.0.00 in 2025:");
  ...
  console.log("Total PI for 1711:", totalPI);
}

check1711().catch(console.error);
