...
export default function ConselhoSaudePage() {
  return (
    <ContentPage
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <a href="mailto:cms.padremarcos@gmail.com" className="text-sm font-semibold text-blue-700 hover:underline">
                cms.padremarcos@gmail.com
              </a>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Telefone (Secretaria de Saúde)</p>
