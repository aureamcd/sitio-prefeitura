    ...
    >
      <div className="space-y-6">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-2 text-gray-600">
              ...
              <div className="space-y-2 w-full">
                <strong>Recurso em caso de negativa:</strong> O cidadão tem <strong>10 dias</strong> para apresentar recurso.
              </div>
            </li>
          </ul>
        </section>
        ...
        <section className="bg-white border border-gray-100 rounded-2xl p-6 space-y-4 shadow-sm">
          ...
          <p className="text-gray-600 leading-relaxed">
            A Lei de Acesso à Informação no município é regulamentada pelo seguinte instrumento, disponibilizado em formato de texto estruturado:
          </p>
          <Link
        ...
        <section className="bg-white border border-gray-100 rounded-2xl p-6 space-y-4 shadow-sm">
          ...
          <Link href="/lgpd" className="inline-flex items-center gap-2 text-blue-600 font-bold hover:underline">
            <ShieldCheck size={16} />
