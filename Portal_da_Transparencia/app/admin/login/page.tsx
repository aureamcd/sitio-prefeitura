...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#173572] via-[#1a3f7a] to-[#0f264f] flex items-center justify-center px-4">
      {/* Background pattern */}
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
          ...
          <div className="p-8 md:p-10">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-[#173572]/10 rounded-2xl mb-4">
                <Lock className="w-8 h-8 text-[#173572]" />
              </div>
              <h1 className="text-2xl font-bold text-gray-900">
                Painel Administrativo
              </h1>
              <p className="text-sm text-gray-500 mt-1">
                Portal da Transparência - Padre Marcos - PI
              </p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl text-sm text-gray-900
                      focus:ring-2 focus:ring-[#173572]/20 focus:border-[#173572]
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-[#173572] text-white font-semibold rounded-xl
                  hover:bg-[#122a5a] active:scale-[0.98]
