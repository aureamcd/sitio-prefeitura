  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={scrollToTop}
        className={`fixed bottom-6 right-6 bg-[#173572] text-white p-3 rounded-full shadow-lg hover:bg-[#0f2847] z-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#173572] transition-all duration-300 ${
